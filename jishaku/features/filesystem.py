...
class FilesystemFeature(Feature):
    ...
    @Feature.Command(parent="jsk", name="cat", message_command=True, slash_command=False)
    ...
    @Feature.Command(parent="jsk", name="curl", message_command=True, slash_command=False)
